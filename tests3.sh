...
urls="$(_build/prod/rel/mongooseim/bin/mongooseimctl http_upload connect.twible.com test.txt "$filesize" "$content_type" 600)"
...
curl -v -T "./tmp.txt" -H "x-amz-acl: public-read" -H "Content-Type: $content_type" "$put_url"
